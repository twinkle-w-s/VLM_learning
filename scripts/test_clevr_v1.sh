...
# CLEVR v1 test: evaluate the independent image-level test split.
...
MANIFEST_PATH="${EXP_ROOT}/data/test_image_holdout_5pct.jsonl"
CHECKPOINT_PATH="${DATA_ROOT}/runs/clevr_spatial_v1/projector_warmup/clevr_spatial_v1_projector_warmup_768.pth"
OUTPUT_PATH="${DATA_ROOT}/reports/clevr_spatial_v1/projector_warmup/test_generation.jsonl"
